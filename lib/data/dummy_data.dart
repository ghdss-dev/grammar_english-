...
const DUMMY_ENGLISH = [
  ...
  const English(
      ...
      cost: Cost.Cheap,
      complexity: Complexity.Simple,
      imageUrl: 'https://educamarket.com.br/wp-content/uploads/2023/10/3-3.png',
      duration: 40,
      questions: [
  ...
  const English(
      ...
      contents: [
        '1 - spent two years in Greece after. I finished my degree '
            '= passei dois anos na Grécia depois de terminar minha graduação ',
        '2 - I lived on the island of Crete for the first year. = Morei na ilha de Creta durante o primeiro ano.',
        '3 - Then I moved to Salonika = Depois me mudei para Salônica',
        '4 - Crete was a great experience but Salonika was the complete opposite '
            '= Creta foi uma ótima experiência, mas Salônica foi completamente o oposto',
        '5 - I had read so much about Salonika that I thought I was going to like it. = '
            'Eu tinha lido tanto sobre Salônica que pensei que iria gostar.',
        '6 - I lived about three kilometres from the centre and taught children English. = '
            'Eu morava a cerca de três quilômetros do centro e ensinava inglês às crianças.',
        '7 - There were few English people in the city = Havia poucos ingleses na cidade',
        '8 - Then I became ill and spent days going from hospital to hospital having tests. = '
            'Então fiquei doente e passei dias indo de hospital em hospital para fazer exames.',
